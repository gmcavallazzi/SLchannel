...
def run():
    ...
    for sl_extra, min_ratio in [
        ...
        u1 = run_solver('sl', 0.02, traj_order=4, freeze_forcing=True,
                        sl_extra=sl_extra)
        u2 = run_solver('sl', 0.01, traj_order=4, freeze_forcing=True,
                        sl_extra=sl_extra)
        u4 = run_solver('sl', 0.005, traj_order=4, freeze_forcing=True,
                        sl_extra=sl_extra)
